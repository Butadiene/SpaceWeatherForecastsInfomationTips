                        ...
                        memo = "SDO衛星による取得画像。波長ごとに見れるため、太陽表面の概観がエネルギーごとにわかる。 \
                            ...
                            <br> \
                             ...
                             <br> 主なもの： \
                                 ...
                                 <br> \
                                 <br> AIA 193 (gold)-エネルギー的にはgreenとpurpleの間。後述するが、コロナの放出（Dimming）が見えやすいことが多く、CMEが放出されるが疑われる際には確認を推奨。\
                                 <br> \
                                 <br> AIA 094、211、193あたりの波長帯の画像では、CMEが見えることがある。\
                                 ...
                                 <br> PFSSから何かを言うのはかなりの知識が必要なようで、予報ではあまり使われない模様。また、Potentialから計算しているので、重要なはずの自由エネルギーが無視されていることにも注意。\
                                    <br> PFSS追記: PFSSは背景太陽風を読むときに参考になる。一方で、自由エネルギーが重要になるCMEを考えるためにはあまり使えない。",\
