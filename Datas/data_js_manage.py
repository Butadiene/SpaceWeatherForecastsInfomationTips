        ...
        "L1 Solar wind": { **create_child_object("SWPC REAL TIME SOLAR WIND","https://www.swpc.noaa.gov/products/real-time-solar-wind", True, \
                            ...
                            **create_child_object("ACE REAL TIME SOLAR WIND", "https://www.swpc.noaa.gov/products/ace-real-time-solar-wind", True, \
                            ...
                            memo="ACEのリアルタイムの太陽風観測結果。右側にあるリストから、色々な観測機器のグラフが選べる。\
                             ...
                             <br> 一般にCMEではEPAMの示す値は急激に上がり、高速太陽風では徐々に上がっていく傾向にある。しかし、実際にはCMEと高速太陽風が同時に到来したりと判断に迷うケースも多い。\
                             <br> そのためCMEと高速太陽風のどちらが到来しているかについての判断を行う際は、発生源との突き合わせが重要である。具体的には\
                             <br> &nbsp&nbsp;CME: 到来する数日前に太陽表面のどこかにおいてCMEのようなイベントが発生しているかを確認(SDOによる太陽表面の画像を使う) \
                             <br> &nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;発生している場合は、それに対応する現象がSOHOのLASCOなどのコロナグラフでも対応現象が見えているかを確認 \
                             <br> &nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;見えている場合は、そこで計算したCMEの速度を導出し、地球への到達時間を推測。それとEPAMの上昇時間を突き合わせ検討する。\
                             <br> &nbsp&nbsp;ちなみに、CMEは発生した場所から等方的に広がることが一般的であるため、地球から見えている太陽表面のうち、リム際を除くどの場所で起きても警戒する必要がある。\
