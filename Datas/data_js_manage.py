                        ...
                        memo = "SDO衛星による取得画像。波長ごとに見れるため、太陽表面の概観がエネルギーごとにわかる。 \
                            ...
                            <br> 太陽の表面が1周期前と現在で近い模様をしている場合、1周期前に発生した事象を予報に活用できる(特にコロナホールによる高速太陽風)。\
                             ...
                             <br> 主なもの： \
                                 ...
                                 <br> &nbsp&nbsp;コロナホールから飛び出す太陽風は太陽半径方向に飛んでいく傾向があるため、コロナホールがあった場合、子午線にいる時刻を認識すると良い。\
    ...
    "Solar wind": {
        ...
        "L1 Solar wind": { **create_child_object("SWPC REAL TIME SOLAR WIND","https://www.swpc.noaa.gov/products/real-time-solar-wind", True, \
                            ...
                            **create_child_object("ACE REAL TIME SOLAR WIND", "https://www.swpc.noaa.gov/products/ace-real-time-solar-wind", True, \
                            ...
                            memo="ACEのリアルタイムの太陽風観測結果。右側にあるリストから、色々な観測機器のグラフが選べる。\
                             ...
                             <br> \
                             <br> しかし、実際にはCMEと高速太陽風が同時に到来したりと判断に迷うケースも多い。\
                             <br> そのためCMEと高速太陽風のどちらが到来しているかについての判断を行う際は、発生源との突き合わせも重要である。具体的には\
                             <br> &nbsp&nbsp;CME: 到来する数日前に太陽表面のどこかにおいてCMEのようなイベントが発生しているかを確認。(SDOによる太陽表面の画像を使う) \
                             <br> &nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;発生している場合は、それに対応する現象がSOHOのLASCOなどのコロナグラフでも見えているかを確認。 \
                             <br> &nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;見えている場合は、コロナグラフの観測画像を使ってCMEの速度を概算し、地球への到達時間を推測。それとEPAMの上昇時間を突き合わせ検討する。\
                             <br> &nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;なお、CMEは発生した場所から等方的に広がることが一般的である。よって、CMEの発生源が太陽表面のうち地球から見えている側であれば、地球に到来している可能性がある。\
                             <br> &nbsp&nbsp;高速太陽風: 高速太陽風が到来する3-4日前に、中央子午線付近にコロナホールがあるかどうかを確認する。コロナホールはSDOのAIA211で検討するのがおすすめ。\
                             <br> &nbsp&nbsp;&nbsp&nbsp; 高速太陽風はCMEと違ってコロナホールから太陽半径方向に飛んでいくとされる。(そのため、子午線付近にいる際の時刻などが大事)\
                             <br> \
        ...
        "CME in space": { **create_child_object("SOHO LASCO C2 & C3", "https://soho.nascom.nasa.gov/data/Theater/", True, \
                        ...
                        memo="SOHOのコロナグラフを用いた観測機器LASCOによる動画。これにより、CMEがどのように宇宙空間に広がっていったかがわかる。 \
                         <br> SDOの太陽表面画像では太陽表面の事象しか見れないので、これを見るのは重要。\
                         <br> CMEは一般的に発生場所から等方的に広がる。\
                         <br> そのため、CMEが太陽の面のうち地球から見えている場所のどこかで発生している場合は地球に到来する可能性があるが、裏側で発生している場合到来の可能性はあまりない。\
                         <br> よって、SDOなどの太陽表面画像と付き合わせてCMEの発生源を特定するのは大事。\
                         <br> なお、CMEの発生において太陽表面での変動現象からLASCOでプラズマの放出が確認できるまで1時間程度の遅延が生じる。(CMEの伝搬時間)\
                         <br> また、LASCOで見て中央から360度プラズマが広がっているように見える場合、これをフルハローCMEと呼ぶ。\
