            ...
            <ol>
                ...
                <li>
                    ...
                    <p>4日前からの太陽活動の動画を、波長帯ごとにざっと確認する。SDO衛星の動画を見ると良い。ここ4日で活動的な領域の大雑把な把握を、波長帯別に行う。\
                        ...
                        <br> どこを見るか迷う場合、とりあえずSDOのAIA 094, 211, 304, 1600, Magnetogramはあたり?{get_site_info(data,"Solar Monitor")}{get_site_info(data,"SDO Images")} {get_site_info(data,"SDO Images Dashboard")}</p>
                </li>
                <li>
                    活動領域(≒黒点近辺)の詳細を確認
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <br> &nbsp&nbsp&nbsp&nbsp;例えば低緯度子午線付近に大きなコロナホールがあった場合、現在太陽風に顕著な変動がなくても、数日後に高速太陽風が到来する可能性があると言える。</p>
                        </li>
                    </ol>
                </li>
                <li>
