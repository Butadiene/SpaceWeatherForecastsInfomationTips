                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <br> CME候補リストにおいては、どの領域発生したものか、いつ発生したものなのか、を重視する。\
                            <br> 特に、太陽面の「地球から見えている側」で発生しているものを把握する。これらは地球に飛来する可能性がある。\
                            <br> また、リストアップされたCMEに対応する太陽フレアイベントがあるかを確認する。{get_site_info(data,"Solar and geophysical events")}</p>
                        </li>
                        <li>
                            太陽風観測データとCMEの対応の確認。
                            <p>太陽風データ、プラズマの観測データと確認したCMEを突き合わせ、確認を行う。\
                            <br> まず、CMEのうち太陽面の「地球から見えている側」で発生しているものを把握する。これらは地球に飛来する可能性がある。\
