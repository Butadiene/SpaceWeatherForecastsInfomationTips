                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <p>以下のリストを見て、各活動領域のタイプ分け、面積、黒点数などを確認。\
                                        <br>この時、昨日から各活動領域はどのように変化したのか（面積は増えたか、磁場構造は変わったか）を確認するのが重要。 {get_site_info(data,"SOLAR REGION SUMMARY")}</p>
                                </li>
                                <li>
                                    イベントリストを確認
                                    <p>各活動領域がどのぐらいの規模、数のフレアを起こしたかを確認する。以下のリストを使用すると良い。{get_site_info(data,"LMSAL last event reports")}</p>
                                </li>
                            </ol>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <br> もし高速の太陽風が飛んできていれば、それと対応するコロナホールはどれか。\
                            <br> コロナホールが見えているが高速太陽風が見当たらない場合、それはどこにあるのか。今後地球に到来する可能性はあるのか。</p>
                        </li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        <li>
                            ...
                            <p> SDO衛星の画像などから、CMEの候補となる現象を確認する。\
                                高エネルギー帯の波長でのコロナの吹き飛び、304によるフィラメントの吹き飛びが重要。\
                        ...
                        <li>
                            ...
                            <p>SOHO衛星のコロナグラフによる観測機器LASCOのデータを確認し、宇宙空間にプラズマが放出されるイベントを確認する。\
                              <br> 淡くて見づらいことも多いので、差分画像も活用すると良い。{get_site_info(data,"SOHO LASCO C2 & C3")}{get_site_info(data,"SOHO LASCO C2 & C3 Diff")}</p>
                        </li>
                        <li>
                            CMEの確認
                            <p>LASCO画像でのプラズマ放出イベントとSDO画像でのCMEの候補現象の突き合わせを行う。両方で時間的に一致しているイベントはCMEと言えることが多い。\
                            <br> 確認できた場合はどこの活動領域から放出されているか、どの方向に飛んでいるかも把握する。</p>
                        </li>
                        <li>
                            太陽風観測データとCMEの対応の確認
                            <p>太陽風データ、プラズマの観測データと確認したCMEを突き合わせ、確認を行う。\
                            <br>太陽風データの中にCME到達らしきイベントがあればそれがどのCMEによるものなのか。ない場合は、確認したCMEの中に到達する恐れがあるものはあるのかを考える。</p>
                        </li>
                    </ol>
                </li>
            </ol>
