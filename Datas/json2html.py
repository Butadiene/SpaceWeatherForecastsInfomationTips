    ...
    <ol>
        ...
        <li>
            ...
            <ol>
                <li>
                    L1地点での太陽風の現況把握
                    <p>L1地点での太陽風の現況把握を行う。これにより地球近辺にどのような太陽風が到来しているかがわかる。{get_site_info(data,"SWPC REAL TIME SOLAR WIND")}</p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ol>
                        高速太陽風とコロナホールの対応の確認
                        <p>以上の情報から、現況把握を行う。着目点は以下が代表的。<br> もし高速の太陽風が飛んできていれば、それと対応するコロナホールはどれか。\
